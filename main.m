...
payload =1000000;
I = imread('Lena.tiff');
imwrite(I,'Lena.jpg','jpeg','quality',70);%生成质量因子为70的JPEG图像
imwrite(I,'Ori_Lena.jpg','jpeg','quality',70);%生成质量因子为70的JPEG图像
%% 解析JPEG文件
...
%% 数据提取
stego_jpeg_info = jpeg_read('stego_Lena.jpg');%解析JPEG图像
